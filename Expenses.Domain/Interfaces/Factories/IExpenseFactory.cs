...
public interface IExpenseFactory
{
    ...
    Task<Expense> CreateExpense(int categoryId, decimal amount, string currency, DateTime transactionDate, int walletId, int authorId);
    ...
    /// <returns>A <see cref="Task"/> representing the asynchronous operation. The result is the created <see cref="Expense"/> entity.</returns>
    Task<Expense> CreateExpense(int categoryId, decimal amount, string currency, DateTime transactionDate, int walletId, int authorId, string description);
    ...
    /// <param name="description">The description of the expense.</param>
    /// <returns>A <see cref="Task"/> representing the asynchronous operation. The result is the created <see cref="Expense"/> entity.</returns>
    Task<Expense> CreateExpense(int categoryId, Money amount, DateTime transactionDate, int walletId, int authorId, string description);
}