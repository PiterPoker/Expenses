...
public class WalletUpdateException : Exception
{
    ...
    public WalletUpdateException(long id, string message) : base($"Failed to update wallet with ID {id}. {message}") { }
    ...
    public WalletUpdateException(long id, string message, Exception innerException) : base($"Failed to update wallet with ID {id}. {message}", innerException) { }
}