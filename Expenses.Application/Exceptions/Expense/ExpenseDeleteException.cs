...
/// <summary>
/// Exception thrown when an error occurs during the deletion of an expense.
/// </summary>
public class ExpenseDeleteException : Exception
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ExpenseDeleteException"/> class with a specified expense ID and error message.
    /// </summary>
