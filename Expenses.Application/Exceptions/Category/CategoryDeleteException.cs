...
public class CategoryDeleteException : Exception
{
    ...
    public CategoryDeleteException(long id, string message) : base($"Failed to delete category with ID {id}. {message}") { }
    ...
    public CategoryDeleteException(long id, string message, Exception innerException) : base($"Failed to delete category with ID {id}. {message}", innerException) { }
}